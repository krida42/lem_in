...
t_lemin* generate_test(void)
{
	...
	add_directed_link(lemin->rooms_by_id[1], 0); // A -> Start

	add_directed_link(lemin->rooms_by_id[0], 2); // Start -> B
	add_directed_link(lemin->rooms_by_id[2], 0); // B -> Start

	add_directed_link(lemin->rooms_by_id[1], 3); // A -> C
	add_directed_link(lemin->rooms_by_id[3], 1); // C -> A

	add_directed_link(lemin->rooms_by_id[1], 5); // A -> E
	add_directed_link(lemin->rooms_by_id[5], 1); // E -> A

	add_directed_link(lemin->rooms_by_id[2], 8); // B -> Z
	add_directed_link(lemin->rooms_by_id[8], 2); // Z -> B

	add_directed_link(lemin->rooms_by_id[3], 4); // C -> D
	add_directed_link(lemin->rooms_by_id[4], 3); // D -> C

	add_directed_link(lemin->rooms_by_id[4], 7); // D -> G
	add_directed_link(lemin->rooms_by_id[7], 4); // G -> D

	add_directed_link(lemin->rooms_by_id[4], 9); // D -> End
	add_directed_link(lemin->rooms_by_id[9], 4); // End -> D

	add_directed_link(lemin->rooms_by_id[5], 4); // E -> D
	add_directed_link(lemin->rooms_by_id[4], 5); // D -> E

	add_directed_link(lemin->rooms_by_id[5], 6); // E -> F
	add_directed_link(lemin->rooms_by_id[6], 5); // F -> E

	add_directed_link(lemin->rooms_by_id[6], 7); // F -> G
	add_directed_link(lemin->rooms_by_id[7], 6); // G -> F

	add_directed_link(lemin->rooms_by_id[7], 9); // G -> End
	add_directed_link(lemin->rooms_by_id[9], 7); // End -> G

	add_directed_link(lemin->rooms_by_id[8], 4); // Z -> D
	add_directed_link(lemin->rooms_by_id[4], 8); // D -> Z
